# PocketRiscV - LLM Inference on Analogue Pocket
...
2. Place model files in `Assets/pocketriscv/common/`:
...
└── release/                       # SD card files
    ├── Cores/ThinkElastic.PocketRiscV/
    └── Platforms/
```
